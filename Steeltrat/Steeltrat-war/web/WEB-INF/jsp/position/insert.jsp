...
<html>
    ...
    <body>
        ...
        <form method="POST" id="formInsert" action="home">
            <label for="namePosition">Nome Cargo:</label> <input type="text" name="name_position" id="name_position" size="35" maxlength="35" onkeypress="return alpha(event,letters)">
            <br>
